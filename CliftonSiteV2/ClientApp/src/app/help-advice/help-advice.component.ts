...
export class HelpAdviceComponent {
  ...
  public trainingHelp = [
    new HelpItem("cutlery", "Feeding your dog before training", "If you intend to use food as a reward during training we recommend not feeding them before, or only giving your dog a small meal in the afternoon. If you do fed your dog before training we recommend feeding them at least 2 hours before training."),
    ...
    new HelpItem("mood", "Try to remain calm whist training", "We've had times where things go completely wrong when training, but please try to remain calm and listen to your trainer as they've seen it all before and will have some good advice."),
    new HelpItem("hospital", "If your dog is unfit to train", "if your dog is unfit to train please let one of the committee members know, as you will not be able to train with that dog."),
